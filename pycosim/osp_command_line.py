...
# %% auto 0
__all__ = ['PATH_TO_COSIM', 'SimulationResult', 'SimulationError', 'ModelVariables', 'FMUModelDescription', 'LoggingLevel',
           'run_cli', 'run_single_fmu', 'deploy_output_config', 'deploy_scenario', 'clean_header', 'run_cosimulation']
...
if platform.startswith("linux") or platform.startswith("darwin"):
    ...
    COSIM_FILE_NAME = os.path.join(_MODULE_PATH, "..", "osp_cosim", "linux", "bin", "cosim")
